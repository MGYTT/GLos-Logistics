  ...
  return (
    <motion.header
      ...
      className={cn(
        ...
        scrolled
          ? 'bg-zinc-950/95 backdrop-blur-2xl border-b border-white/[0.07] shadow-xl shadow-black/30'
          : 'bg-transparent',
      )}
    >
      <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-2.5 group shrink-0">
          <motion.div
            ...
            whileTap={{ scale: 0.95 }}
            className="w-9 h-9 bg-amber-500 rounded-xl flex items-center justify-center shadow-lg shadow-amber-500/40 relative overflow-hidden"
          >
            ...
            <Truck className="w-5 h-5 text-black relative z-10" />
          </motion.div>
          <motion.span
        ...
        <nav className="hidden md:flex items-center gap-0.5">
          ...
          <motion.div
            initial={{ opacity: 0, y: -10 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.04 * navLinks.length, duration: 0.35 }}
          >
            <Link
              href="/support"
              className={cn(
            ...
            >
              <motion.div
                animate={pathname !== '/support' ? { scale: [1, 1.25, 1] } : {}}
        ...
        <div className="hidden md:flex items-center gap-2 shrink-0">
          ...
          <Link href="/hub">
            <motion.div whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.96 }}>
              <Button
                size="sm"
                className="bg-amber-500 text-black hover:bg-amber-400 font-bold gap-1.5 shadow-md shadow-amber-500/30 relative overflow-hidden group transition-all"
              >
